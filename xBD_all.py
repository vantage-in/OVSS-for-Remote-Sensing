...
IMAGE_DIR = Path('data/WHU_Sat_II/Satellite_dataset_II_East_Asia/1.cropped/test/image')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/WHU_Sat_II/Satellite_dataset_II_East_Asia/1.cropped/test/label_cvt')
BASE_OUTPUT_DIR = Path('present/whu-sat-II')
