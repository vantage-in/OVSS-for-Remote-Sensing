...
IMAGE_DIR = Path('data/Inria/AerialImageDataset/train/img_dir/split_test')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/Inria/AerialImageDataset/train/ann_dir/split_test')
BASE_OUTPUT_DIR = Path('present/inria')
...
def run_inference(model_name, output_dir_name, image_files):
    ...
    if model_name == 'ours':
        model = ProxySegEarthSegmentationCatRandom(
            ...
            prob_thd=0.65, cls_variant="none", vfm_model="dino"
        )
