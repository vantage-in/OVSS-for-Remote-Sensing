...
IMAGE_DIR = Path('data/GlobalRoadSet_Val/SpaceNet_test_567/img')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/GlobalRoadSet_Val/SpaceNet_test_567/label_cvt')
BASE_OUTPUT_DIR = Path('present/spacenet')
