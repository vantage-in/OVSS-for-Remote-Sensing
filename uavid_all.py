...
IMAGE_DIR = Path('data/UAVid/img_dir/test')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/UAVid/ann_dir/test')
BASE_OUTPUT_DIR = Path('present/uavid')
...
class_info = {
    ...
    2: ("road", "#FFFFFF"),    # 노랑
    3: ("car", "#0045FF"),        # 연두 (GreenYellow)
    4: ("tree", "#226126"),    # 주황
    5: ("vegetation", "#4BB549"),  # 빨강
    6: ("human", "#FFC0CB")         
}
...
name_list = ['background', 'building', 'road', 'car', 'tree', 'vegetation', 'human']
