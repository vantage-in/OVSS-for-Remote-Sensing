...
IMAGE_DIR = Path('data/VDD/test/src')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/VDD/test/gt')
BASE_OUTPUT_DIR = Path('present/vdd')
...
class_info = {
    ...
    1: ("facade", "#DE1F07"),          # 청록 (Teal)
    2: ("road", "#FFFFFF"),    # 노랑
    3: ("vegetation", "#4BB549"),
    4: ("vehicle", "#FFC0CB"),
    5: ("roof", "#800000"),    # 주황
    6: ("water", "#0045FF")        # 연두 (GreenYellow)     
}
...
name_list = ['background', 'facade', 'road', 'vegetation', 'vehicle', 'roof', 'water']
