...
IMAGE_DIR = Path('data/CHN6-CUG/val/image_cvt')
# Updated LABEL_DIR to the new path
LABEL_DIR = Path('data/CHN6-CUG/val/label_cvt')
BASE_OUTPUT_DIR = Path('present/chn6-cug')
...
def run_inference(model_name, output_dir_name, image_files):
    ...
    if model_name == 'ours':
        model = ProxySegEarthSegmentationCatRandom(
            ...
            prob_thd=0.85, cls_variant="none", vfm_model="dino"
        )
